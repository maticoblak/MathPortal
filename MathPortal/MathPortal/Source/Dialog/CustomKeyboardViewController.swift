...
class CustomKeyboardViewController: UIViewController {
    ...
    let keyboardButtons: [Button.ButtonType] = Button.ButtonType.integers + [.plus, .minus, .back, .forward, .delete, .brackets, .done, .levelIn, .levelOut, .fraction, .root, .exponent, .index, .indexAndExponent, .logarithm] + Button.ButtonType.letters
}
