    ...
    class Indicator {
        ...
        func forward() {
            if let component = expression as? Component {
                ...
                if (component is Fraction || component is Root || component is IndexAndExponent || component is Index), offset == component.items.count - 1 {
                    levelOut()
        ...
        func back() {
            if let component = expression as? Component {
                ...
                if (component is Fraction || component is Root || component is IndexAndExponent || component is Index), offset == 0 {
                    levelOut()
                // if component only has Empty expression in items - don't want to be in front or behinde it
                } else if component.items.count == 1, component.items.first is Empty {
                    levelOut()
        ...
        func addInteger(value: String?) {
            ...
            if let component = expression as? Component {
                ...
                // the indicator is on empty field
                    ...
                    if component is Fraction || component is Root || component is IndexAndExponent || component is Index {
                    ...
                    guard (component is Fraction || component is Root || component is IndexAndExponent || component is Index) == false else { return }
        ...
        func delete() {
            if let component = expression as? Component {
                if component is Root || component is Fraction || component is IndexAndExponent || component is Index {
